...
def load():
    global sys_font, color_active, color, active, color_inactive, k, text_area, obstaculos1, coins1,obstaculos2, obstaculos3, voltar, clock, x, cl1, cl, i, scroll, fase, play, quad, over, font, sair, inicio, p,  white, black, border_color, font_color, input_text
...
def mouse_click_down(px_mouse, py_mouse, mouse_buttons):
    global play, sair, voltar, cl1, active, k
...
def main_loop(screen):  
    global clock, voltar, width, scroll, fundo, fase, play, sair, fade_alpha, fade_img, fade, cl1, text_area, color, color_active, color_inactive, active, input_text, nome_jogador
    running = True
